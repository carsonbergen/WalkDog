...
export default function Navbar(props) {
  return (
    <>
      <div className="fixed bottom-0 left-0 w-full py-2 px-8 z-[9999]">
          ...
          <div className="flex-shrink-0 w-[25%] flex flex-row justify-center">
            ...
            >
              <svg
                ...
                viewBox="0 0 256 256"
                className="stroke-[2rem] fill-yellow stroke-black paint-stroke"
              >
          ...
          <div className="flex-grow flex flex-row justify-center">
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 256 256"
                className="stroke-[1rem] fill-yellow stroke-black paint-stroke"
              >
